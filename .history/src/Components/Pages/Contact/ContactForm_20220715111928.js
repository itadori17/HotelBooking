                ...
                <form onSubmit={formSubmit }>
                    <div className='grid1'>
                        ...
                        <div className='input'>
                            ...
                            <input type='email' name='email' id={subject} onChange={(e) => setSubject(e.target.value)} />
                        </div> 
                        <div className='input inputlast'>
                            <span>
                                Message 
                            </span>
                            <input type='email' name='email' id={message} onChange={(e) => setMessage(e.target.value)} />
                        </div> 
                    </div>
